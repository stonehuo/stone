...
public class ComPatentSum {
    ...
    /**
     * 汇总类型：0--合计，1--平均数，2--方差，3--标准差，4--取分；5--得分
     */
    ...
    public Double getSumScore(){
    	return icln+cigc+dcln+clt_a+ipcsc+rmn+cipc+inco+patt_a+plic+pcc+ppc+tcc+despage+drawpage+sfcl+fajp+faus+faot+clt_b+clt_c+patt_b;
    }
}