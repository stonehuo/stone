 ...
 *
 */
public class ProductAve {
	
	//年：2016	2016-2015	2016-2014	2016-2013	2016-2012
	public String r15;
	//年描述：当年   前2年平均	前3年平均	  前4年平均	前5年平均
	public String r16;
	
	//专利使用前数据：销售量平均值
	public Double r20;
	//专利使用前数据：销售单价（不含税）平均值
	public Double r21;	
	//专利使用前数据：单位成本（不含税）平均值
	public Double r24;
	//专利使用后数据（企业当前）：销售量平均值
	public Double r29;
	//专利使用后数据（企业当前）：销售单价（不含税）平均值
	public Double r30;
	//专利使用后数据（企业当前）：销售收入平均值
	public Double r31;
	//专利使用后数据（企业当前）：单位成本（不含税）平均值
	public Double r33;
	//企业报表数据：毛利率平均值
	public Double r38;
	//企业报表数据：主营业务利润率平均值
